...
info.input(1); % Display the information about the first input device

% optional
% ID = 0; % uncomment to select the input audio device specified by the device identifier (ID) 0
